...
module.exports = class Pairs {
  ...
  mutateRandomPair() {
    ...
    const randomPlusMinus10Perc = (Math.random() - 0.5) * 0.2;
    data[index].buy = data[index].buy + data[index].buy * randomPlusMinus10Perc;
    data[index].sell = data[index].sell + data[index].sell * randomPlusMinus10Perc;
